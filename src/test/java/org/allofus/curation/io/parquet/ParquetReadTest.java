...
public class ParquetReadTest extends TestCase {

  public void testReadParquet() {
    TestPipeline p = TestPipeline.create().enableAbandonedNodeEnforcement(false);

    String input_type = "parquet";
    Schema note_schema = NLPSchema.getNoteSchema();

    org.apache.avro.Schema avroSchema = ReadSchemaFromAvro.ReadSchema("note.avsc");
    ...
    Row row_1 = Row.withSchema(note_schema)
      ...
      .addValue("2020-10-10")
      .addValue("2020-10-10 01:01:01+00")
